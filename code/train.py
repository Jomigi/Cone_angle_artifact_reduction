...
def main(msd, network, epochs, in_channels, out_channels, depth, width, reflect, 
         batch_size, dilations, position, dataset_dir, save_network_path, 
         results_dir, training_scans, val_scans, test_scans, selection_seed, train, 
         load_model, it):
...
#########################################################################################
    ...
    img = np.zeros((501, 501, 501), dtype=np.float32) 
